...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeHelloBundle', '/var/www/Symfony/app/Resources/AcmeHelloBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeHelloBundle', '/var/www/Symfony/src/Acme/HelloBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KsoftTssaaLoginBundle', '/var/www/Symfony/app/Resources/KsoftTssaaLoginBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KsoftTssaaLoginBundle', '/var/www/Symfony/src/Ksoft/Tssaa/LoginBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KsoftTssaaStoreBundle', '/var/www/Symfony/app/Resources/KsoftTssaaStoreBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KsoftTssaaStoreBundle', '/var/www/Symfony/src/KsoftTssaa/StoreBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->setNamespace('sf2orm_default_987aa0ac6a134a0d555795fd450e9888');

        $e = new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($a);

        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, array(0 => '/var/www/Symfony/src/Ksoft/Tssaa/LoginBundle/Entity', 1 => '/var/www/Symfony/src/KsoftTssaa/StoreBundle/Entity'));
        ...
        $h->setProxyDir('/var/www/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/Symfony/vendor/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
